(function () {
    ...
    angular
        ...
        .controller('ReportTokenController', ReportTokenController);

    ReportTokenController.$inject = ['$scope', 'ReportToken', '$uibModal'];

    function ReportTokenController($scope, ReportToken, $uibModal) {
        ...
        vm.downloadExcel = function () {
            ...
            window.open('/api/reports/tokens/excel?' + queryString, "_blank");
            /*
             $http({
             method: 'GET',
        ...
        function showTokenTrend(metrics) {
            ...
            ReportToken.trend(vm.condition).$promise.then(function (response) {
                var apiTrendModalInstance = $uibModal.open({
                    templateUrl: 'app/templates/modal/trend-chart.html',
                    controller: 'TokenTrendModalController',
                    controllerAs: 'vm',
                    size: 'lg',
                    resolve: {
                        items: function () {
...
(function () {
    ...
    angular
        .module('portalApplicationApp')
        .controller('TokenTrendModalController', TokenTrendModalController);

    TokenTrendModalController.$inject = ['$uibModalInstance', 'items'];

    function TokenTrendModalController($uibModalInstance, items) {
        var vm = this;
        ...
        function downloadExcel() {
            ...
            var queryString = $.param(condition, true);
            window.open('api/reports/tokens/trend/excel?' + queryString, "_blank");
        }
