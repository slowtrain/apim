(function () {
    ...
    angular
        ...
        .controller('ReportBillingProvidingController', ReportBillingProvidingController);

    ReportBillingProvidingController.$inject = ['Billing', '$scope', 'ReportBilling', '$uibModal', 'Principal'];

    function ReportBillingProvidingController(Billing, $scope, ReportBilling, $uibModal, Principal) {
        ...
        vm.clickSearchButton = function (allMode) {
            ...
            var condition = $.extend({filterOrgId: vm.selectedOrganization? vm.selectedOrganization.id: null, providerId: vm.user.$$state.value.organization.id, page: vm.page, size: vm.size, sort: vm.sort}, vm.condition);
        ...
        vm.downloadExcel = function () {
            ...
            var condition = $.extend({filterOrgId: vm.selectedOrganization? vm.selectedOrganization.id: null, providerId: vm.user.$$state.value.organization.id}, vm.condition);
