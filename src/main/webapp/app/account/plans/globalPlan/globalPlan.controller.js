(function() {
    ...
    angular
        ...
        .controller('GlobalPlanController', GlobalPlanController);

    GlobalPlanController.$inject =['Principal', '$scope', '$uibModal','apiPlans', 'AlertService', 'CommonUtil'];

    function GlobalPlanController(Principal, $scope, $uibModal, apiPlans, AlertService, CommonUtil) {
...
*/
        $scope.addPlan = function(isGlobal, plan){
            $uibModal.open({
                templateUrl: 'app/account/plans/planEdit-dialog.html',
                controller: 'planEditDialogController',
                controllerAs: 'vm',
                backdrop: 'static',
                size: 'md',
                resolve: {
        ...
        $scope.deletePlan = function(plan, type){
            ...
            $uibModal.open({
                ...
                resolve: {
                    ...
                    if(result) apiPlans.delete({id: plan.id}, loadAll(), onError);
                });
        }
    }
})();
