(function() {
    ...
    angular
        ...
        .controller('ApiPlanController', ApiPlanController);

    ApiPlanController.$inject =['Principal', '$scope', '$uibModal','apiPlans', 'AlertService', 'CommonUtil'];

    function ApiPlanController(Principal, $scope, $uibModal, apiPlans, AlertService, CommonUtil) {
