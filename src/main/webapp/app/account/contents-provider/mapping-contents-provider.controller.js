(function () {
    ...
    angular
        ...
        .controller('MappingContentsProviderController', MappingContentsProviderController);

    MappingContentsProviderController.$inject = ['ApiGroup', '$scope', '$uibModalInstance', 'selectedContents', 'Principal', 'ApprovalLine', 'Api', 'CommonUtil'];

    function MappingContentsProviderController(ApiGroup, $scope, $uibModalInstance, selectedContents, Principal, ApprovalLine, Api, CommonUtil) {
        var vm = this;
        vm.clear = clear;
        vm.save = save;
        ...
        if (selectedContents) {
            if (selectedContents.type == 'mappingApiGroups') {
                ...
                ApiGroup.listForPartner({isPrivate: 'false'}).$promise.then(function(response){
